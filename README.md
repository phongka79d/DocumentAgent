...
- `frontend/` contains a Vite React TypeScript application with an Axios API client, typed document and chat/evidence API contracts, reusable upload/document display components, routed upload and document list pages, compact navigation, responsive/accessibility styling, and a shared file validation helper.
...
The upload and document list screens are mounted and navigable. Chat, evidence viewer, and agent log frontend screens are not implemented yet; only the Plan 14 Batch01 chat/evidence API contracts and clients exist.
...
- The frontend now mounts routed upload and document list screens with compact navigation and responsive/accessibility styling. Chat and evidence API contracts/clients exist, while chat, retrieval, evidence, and agent-log UI remain planned.
