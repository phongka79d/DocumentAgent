...
- `backend/tests/test_langgraph_workflow.py`: mocked coverage for the internal LangGraph QA workflow state, Agent 1 -> Agent 2 -> Agent 3 execution order, and compiled graph availability.
...
- Do not claim GraphRAG, public LangGraph chat workflow, chat API routes, evidence viewer, or agent log APIs are implemented unless corresponding routes/services/tests exist in code.
