...
- `backend/tests/test_chat_api.py`: schema-level coverage for the planned chat ask request/response contracts.
- `backend/tests/test_agent_runs_api.py`: schema-level coverage for the planned agent-run evidence and logs response contracts.
